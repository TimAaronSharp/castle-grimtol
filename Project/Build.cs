...
namespace CastleGrimtol.Project
{
    public class Build
    {
        public List<Item> BuildItems()
        {
            ...
            Item pipBoy = new Item("PipBoy", "Your handy dandy PipBoy!", "Upgrade", " The light is coming from the other side of the cavern. As you walk closer you can see that it is coming from a PipBoy attached to the arm of a skeleton. They're old and tattered, but you'd recognize it's clothes anywhere as a Vault suit. On closer inspection of the skull you see a hole on the right, lined up with another on it's left.", "", true);
