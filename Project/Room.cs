...
namespace CastleGrimtol.Project
{
    public class Room : IRoom
    {
        ...
        public void UseItem(Item item)
        {
            switch (Name)
            {
                case "Vault Cave-in 1":
                    switch (item.Name)
                    {
                        //ROCK CASE TO PREVENT IT FROM NOT DISPLAYING CORRECTLY WHEN TRYING TO USE ROCK IN ROOM 1 AFTER IT HAS BEEN ADDED TO ROOM ITEMS AFTER SEARCHING
                        case "Rock":
